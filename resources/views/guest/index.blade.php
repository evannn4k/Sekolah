...
@section('main')
    ...
    <section class="py-5 bg-light">
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="0">
                        <div class="news-card">
                            ...
                            <div class="news-content">
                                <div class="news-meta">
                                    <span><i class="far fa-calendar"></i> {{ $berita->tanggal_publish }}</span>
            ...
            <div class="text-center mt-5" data-aos="fade-up">
                <a href="{{ route('berita') }}" class="btn btn-modern btn-primary-modern">
                    Lihat Semua Berita
                    <i class="fas fa-arrow-right"></i>
                </a>
            </div>
    ...
    <section class="py-5">
        <div class="container">
                ...
                @foreach ($galeris as $galeri)
                    <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="0">
                        <div class="gallery-item">
                            <img src="{{ asset("storage/images/galeri/$galeri->gambar") }}" alt="Gallery">
            ...
            <div class="text-center mt-5" data-aos="fade-up">
                <a href="{{ route('galeri') }}" class="btn btn-modern btn-primary-modern">
                    Lihat Semua Galeri
                    <i class="fas fa-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center cta-content" data-aos="zoom-in">
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        <a href="{{ route('kontak') }}" class="btn btn-modern btn-outline-modern btn-lg">
                            <i class="fas fa-phone me-2"></i>
                            Hubungi Kami
                        </a>
                        <a href="{{ route('profil') }}" class="btn btn-modern btn-lg"
