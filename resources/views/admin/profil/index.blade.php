                ...
                <div class="col-md-12">
                    <div class="card card-primary-card-outline mb-4">
                        ...
                        @php
                            $id = $profil->id ?? "";
                        @endphp
                        <form action="{{ route('admin.profil.update', $id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        <label for="judul_tentang_sekolah" class="form-label">Judul Tentang Sekolah</label>
                                        <input type="text"
                                            class="form-control @error('judul_tentang_sekolah') is-invalid @enderror"
                                            id="judul_tentang_sekolah" name="judul_tentang_sekolah"
                                            value="{{ $profil->judul_tentang_sekolah ?? '' }}" />
                                        @error('judul_tentang_sekolah')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        @enderror
