                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                        id="judul" name="judul" value="{{ $banner->judul }}" />
                                    @error('judul')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="6"
                                        style="resize: none;">{{ $banner->deskripsi }}</textarea>
                                    @error('deskripsi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('urutan') is-invalid @enderror"
                                        id="urutan" name="urutan" value="{{ $banner->urutan }}" />
                                    @error('urutan')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex flex-column">
                                        <label for="urutan" class="form-label">Status</label>
                                        <div class="btn-group" role="group"
                                            aria-label="Basic radio toggle button group">
                                            <input type="radio" class="btn-check" name="status" id="aktif" value="aktif" {{ ($banner->status == "aktif") ? "checked" : "" }}>
                                            <label class="btn btn-outline-primary" for="aktif">Aktif</label>

                                            <input type="radio" class="btn-check" name="status" id="nonaktif" value="nonaktif" {{ ($banner->status == "nonaktif") ? "checked" : "" }}>
