                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="align-middle">
                                    <td>{{ $no++ }}</td>
                                    <td><img src="{{ asset("storage/images/berita/".$berita->gambar) }}" alt="" height="120px"></td>
                                    <td>{{ $berita->judul }}</td>
                                    <td>{{ $berita->slug }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route("admin.berita.edit", $berita->id) }}" class="btn btn-success btn-sm"><i class="fa fa-pencil-square"></i></a>
